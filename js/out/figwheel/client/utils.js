...
var or__31516__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj39326 = {"detail":data};
return obj39326;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__31504__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__31504__auto__)){
var and__31504__auto____$1 = (window["CustomEvent"]);
...
var args39331 = [];
var len__32629__auto___39337 = arguments.length;
var i__32630__auto___39338 = (0);
while(true){
if((i__32630__auto___39338 < len__32629__auto___39337)){
args39331.push((arguments[i__32630__auto___39338]));

var G__39339 = (i__32630__auto___39338 + (1));
i__32630__auto___39338 = G__39339;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args39331.length)].join('')));
...
var f = (function (){var pred__39334 = cljs.core._EQ_;
var expr__39335 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__39334.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__39335))){
return ((function (pred__39334,expr__39335){
return (function (p1__39327_SHARP_){
return console.warn(p1__39327_SHARP_);
});
;})(pred__39334,expr__39335))
} else {
if(cljs.core.truth_(pred__39334.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__39335))){
return ((function (pred__39334,expr__39335){
return (function (p1__39328_SHARP_){
return console.debug(p1__39328_SHARP_);
});
;})(pred__39334,expr__39335))
} else {
if(cljs.core.truth_(pred__39334.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__39335))){
return ((function (pred__39334,expr__39335){
return (function (p1__39329_SHARP_){
return console.error(p1__39329_SHARP_);
});
;})(pred__39334,expr__39335))
} else {
return ((function (pred__39334,expr__39335){
return (function (p1__39330_SHARP_){
return console.log(p1__39330_SHARP_);
});
;})(pred__39334,expr__39335))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__39341){
var map__39344 = p__39341;
...
var opts = map__39344__$1;
var eval_fn = cljs.core.get.call(null,map__39344__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__39346_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__39348,(0),null);
var v = cljs.core.nth.call(null,vec__39348,(1),null);
...
var args39351 = [];
var len__32629__auto___39354 = arguments.length;
var i__32630__auto___39355 = (0);
while(true){
if((i__32630__auto___39355 < len__32629__auto___39354)){
args39351.push((arguments[i__32630__auto___39355]));

var G__39356 = (i__32630__auto___39355 + (1));
i__32630__auto___39355 = G__39356;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args39351.length)].join('')));
...
if(cljs.core.truth_((function (){var and__31504__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1495209120475