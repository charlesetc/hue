...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__32127__auto__,writer__32128__auto__,opt__32129__auto__){
return cljs.core._write.call(null,writer__32128__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__33185 = o;
(G__33185[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__31504__auto__ = !((jsprops == null));
if(and__31504__auto__){
var and__31504__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__33193 = jsprops;
(G__33193["defaultValue"] = value);

(G__33193["onChange"] = ((function (G__33193,v,value,on_change){
return (function (p1__33191_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__33191_SHARP_);
});})(G__33193,v,value,on_change))
);
...
var vec__33200 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__33200,(0),null);
var id = cljs.core.nth.call(null,vec__33200,(1),null);
var class$ = cljs.core.nth.call(null,vec__33200,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___33205 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___33205 == null)){
} else {
var key_33206 = temp__4661__auto___33205;
(jsprops["key"] = key_33206);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__33208 = (new reagent.impl.template.NativeWrapper());
(G__33208["name"] = c);
...
var len__32629__auto___33214 = arguments.length;
var i__32630__auto___33215 = (0);
while(true){
if((i__32630__auto___33215 < len__32629__auto___33214)){
args__32636__auto__.push((arguments[i__32630__auto___33215]));

var G__33216 = (i__32630__auto___33215 + (1));
i__32630__auto___33215 = G__33216;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__32637__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq33212){
var G__33213 = cljs.core.first.call(null,seq33212);
var seq33212__$1 = cljs.core.next.call(null,seq33212);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__33213,seq33212__$1);
});
...
break;
default:
var G__33220 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__33220;
continue;
...
var n__32439__auto___33223 = a.length;
var i_33224 = (0);
while(true){
if((i_33224 < n__32439__auto___33223)){
(a[i_33224] = reagent.impl.template.as_element.call(null,(a[i_33224])));
...
var a = cljs.core.into_array.call(null,s);
var n__32439__auto___33226 = a.length;
var i_33227 = (0);
while(true){
if((i_33227 < n__32439__auto___33226)){
var val_33228 = (a[i_33227]);
if((cljs.core.vector_QMARK_.call(null,val_33228)) && ((reagent.impl.template.key_from_vec.call(null,val_33228) == null))){
(o["no-key"] = true);
} else {
}

(a[i_33227] = reagent.impl.template.as_element.call(null,val_33228));
...
var ctx = ({});
var vec__33233 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__33233,(0),null);
var derefed = cljs.core.nth.call(null,vec__33233,(1),null);
...
var G__33237 = (cljs.core.count.call(null,argv) - first_child);
switch (G__33237) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__33237){
...
//# sourceMappingURL=template.js.map?rel=1495209113407